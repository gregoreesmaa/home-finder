"""1partner.ee listings adapter — STUB.

GitHub issue: #15 ([portal] 1Partner adapter).
...
tests/fixtures/one_partner_search.html + regression test), keeping the
...
# TODO(#15): confirm the real search path/query params on 1partner.ee.
SEARCH_URL = BASE_URL

# TODO(#15): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#15): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#15): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
