"""okidoki.ee listings adapter — STUB.
...
tests/fixtures/okidoki_search.html + regression test), keeping the kv.ee
...
SOURCE = "okidoki.ee"
BASE_URL = "https://okidoki.ee"
# TODO(#9): confirm the real search path/query params on okidoki.ee.
SEARCH_URL = BASE_URL

# TODO(#9): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#9): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#9): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
