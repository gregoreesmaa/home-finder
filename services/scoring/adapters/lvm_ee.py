"""lvm.ee listings adapter — STUB.

GitHub issue: #18 ([portal] LVM adapter).
...
tests/fixtures/lvm_search.html + regression test), keeping the kv.ee
...
SOURCE = "lvm.ee"
BASE_URL = "https://www.lvm.ee"
# TODO(#18): confirm the real search path/query params on lvm.ee.
SEARCH_URL = BASE_URL

# TODO(#18): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#18): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#18): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
