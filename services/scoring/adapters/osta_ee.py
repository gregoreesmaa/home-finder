...
tests/fixtures/osta_search.html + regression test), keeping the kv.ee
...
SOURCE = "osta.ee"
BASE_URL = "https://osta.ee"
# TODO(#10): confirm the real search path/query params on osta.ee.
SEARCH_URL = BASE_URL

# TODO(#10): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#10): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#10): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
