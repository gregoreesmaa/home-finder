"""city24.ee listings adapter — STUB.

GitHub issue: #6 ([portal] city24.ee adapter).
...
tests/fixtures/city24_search.html + regression test), keeping the kv.ee
...
SOURCE = "city24.ee"
BASE_URL = "https://city24.ee"
# TODO(#6): confirm the real search path/query params on city24.ee.
SEARCH_URL = BASE_URL

# TODO(#6): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#6): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#6): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
