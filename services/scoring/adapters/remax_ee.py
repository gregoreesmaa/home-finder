"""remax.ee listings adapter — STUB.

GitHub issue: #19 ([portal] RE/MAX adapter).
...
tests/fixtures/remax_search.html + regression test), keeping the kv.ee
...
# TODO(#19): confirm the real search path/query params on remax.ee.
SEARCH_URL = BASE_URL

# TODO(#19): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#19): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#19): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
