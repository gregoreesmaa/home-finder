"""uusmaa.ee listings adapter — STUB.

GitHub issue: #13 ([portal] Uus Maa adapter).
...
tests/fixtures/uusmaa_search.html + regression test), keeping the kv.ee
...
# TODO(#13): confirm the real search path/query params on uusmaa.ee.
SEARCH_URL = BASE_URL

# TODO(#13): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#13): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#13): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
