"""kinnisvaraweb.ee listings adapter — STUB.
...
tests/fixtures/kinnisvaraweb_search.html + regression test), keeping the
...
BASE_URL = "https://kinnisvaraweb.ee"
# TODO(#8): confirm the real search path/query params on kinnisvaraweb.ee.
SEARCH_URL = BASE_URL

# TODO(#8): verify selectors against live search markup; keep them here.
SELECTORS = {
    "card": "",
    "url": "",
    "price": "",
...
def fetch_search_html(query: str = "", page_limit: int = 1, timeout: float = 20.0) -> str:
    """TODO(#8): confirm query params/pagination, then return one page of search HTML."""
...
def parse_search_html(html: str) -> List[dict]:
    """TODO(#8): extract [{id, source, source_url, address, price}] like adapters.kv_ee."""
    return []
