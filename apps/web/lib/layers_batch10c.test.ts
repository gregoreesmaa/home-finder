...
describe("batch B10C registry (#121)", () => {
  ...
  it("merges into LAYERS via the B10C-HOOK (page + routes serve all layers)", () => {
    ...
    expect(ids.length).toBe(123); // SPORT-HOOK (#607): +3 sport slices (108 + 3); EHIS-HOOK (#608): +3 school slices (111 + 3); MEDRE-HOOK (#609): +2 care slices (114 + 2); OHUSEIRE-HOOK (#610): +1 station dots (116 + 1); KLIIMA-HOOK (#611): +2 climate slices (117 + 2); POI-HOOK (#612): +3 long-tail slices (119 + 3); FIXIT-HOOK (#623): +1 pins layer (122 + 1)
