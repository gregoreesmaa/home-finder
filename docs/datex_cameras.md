...
`QUOTA_MAX_CALLS = 50` per TTL window (1 h) on the URL table as
backstop (code counts keyed calls per `TTL_S` window; up to
24 × 50 = 1200/day theoretical); 429 = stop; transport errors never
