...
| `bin/` — 17 cron wrappers + guard/start | `built/` — latest sidecars served by the API |
| `crontab.txt` — exact cadence (17 lines) | `state/` — keys, tokens, static vintages (NEVER committed) |
